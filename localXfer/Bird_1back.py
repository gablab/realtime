...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.73.06), August 10, 2012, at 13:08
...
if len(sys.argv) != 4:
    raise Exception("USAGE: python Bird_1back.py <SubjectID> <Visit#> <Timestamp>")
else:
...
trials=data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('Run-Designs/new_localizer_nback1.csv'),
    seed=None)
