...
if not os.path.isdir('/home/vagrant/subjects/'+expInfo['subjID']+'/ltTaskData/Letter_2back/'):
    os.makedirs('/home/vagrant/subjects/'+expInfo['subjID']+'/ltTaskData/Letter_2back/') #if this fails (e.g. permissions) we will get error
filename='/home/vagrant/subjects/'+expInfo['subjID']+'/ltTaskData/Letter_2back/' + os.path.sep + '%s' %(expInfo['date'])
...
#    tex=u'Stimuli/task2_transfer.png', mask=None,
...
show_visual=visual.PatchStim(win=win, name='show_visual',units='pix', 
    tex='sin', mask=None,
    ori=0, pos=[0, 0], size=[375, 275], sf=None, phase=0.0,
...
trials=data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('Run-Designs/practice_new_letter_nback2.csv'),
    seed=None)
